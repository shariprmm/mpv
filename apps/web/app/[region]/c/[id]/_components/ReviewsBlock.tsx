...
export default function ReviewsBlock({
  ...
  async function submit() {
    ...
    try {
      ...
      const res = await fetch(`${base}/public/companies/${companyId}/reviews`, {
        method: "POST",
      ...
      if (data?.stats) {
        ...
        // fallback: просто увеличим счетчик
  ...
  return (
    <div>
      ...
      <div className={styles.UgcCard}>
        <div className={styles.UgcTitle}>Вы сотрудничали с этой компанией?</div>
