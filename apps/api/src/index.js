...
const DEFAULT_FROM = '"MoyDomPro" <no-reply@moydompro.ru>';
const RAW_FROM =
  process.env.SMTP_FROM || process.env.DEFAULT_FROM || process.env.MAIL_FROM || DEFAULT_FROM;
const MAIL_FROM = RAW_FROM.includes("@moydompro.ru") ? RAW_FROM : DEFAULT_FROM;
