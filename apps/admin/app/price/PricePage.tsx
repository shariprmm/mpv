              ...
              <div className={styles.importBlock}>
                <div>
                  ...
                  <div className={styles.hint}>
                    Поддерживаются XLSX/XLS/CSV. Колонки: Тип (Товар/Услуга), Название/Slug/ID, Цена. Экспортируйте текущую выборку по кнопке справа.
                  </div>
                </div>
                <div className={styles.importActions}>
                  ...
                  <button type="button" className={styles.btnGhost} onClick={onExportPriceFile}>
                    Экспорт в Excel
                  </button>
